...
<main>
    <section class="pages">
        <div class="container">
            ...
            <p>
                Мы всегда открыты для вопросов, предложений и новых партнерств в сфере образования. 
                Свяжитесь с командой <strong><?= $domainTitle ?></strong> любым удобным для вас способом. 
                Наши специалисты в Париже готовы проконсультировать вас по всем возможностям платформы по будням с 09:00 до 18:00 (CET).
            </p>
            ...
            <div class="contact-cards">
                <div class="contact-card">
                    ...
                    <h2>Пишите нам</h2>
                    <p>Для общих вопросов, предложений по обучению и технической поддержки:</p>
                ...
                <div class="contact-card">
                    ...
                    <a href="tel:+33189480625" class="contact-link">+33 1 89 48 06 25</a>
                </div>
                ...
                <div class="contact-card">
                    ...
                    <h2>Наш офис</h2>
                    <p>Главный координационный центр платформы расположен по адресу:</p>
                    <address class="contact-address">
                        15 Rue de la Pompe,<br>
                        75116 Paris,<br>
                        France
                    </address>
                </div>
            ...
            <div class="contact-extra">
                <p>
                    Вы также можете воспользоваться интерактивной формой на 
                    <a href="./#contact">главной странице</a> для быстрой отправки запроса эксперту.
                </p>
            </div>
        </div>
    </section>
